...
static func get_characters() -> Array:
	return [
		...
		},
		{
			...
			"select_animation_sheet": "res://assets/players/hunter/select/hunter_live_2d_sheet.png",
			"select_animation_columns": 4,
			"select_animation_rows": 6,
			"select_animation_fps": 12.0,
