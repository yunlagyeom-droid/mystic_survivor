	...
	return [
		{
			...
			"card_image": "res://assets/art/player_mage_ultimate_cutin_candidate.png",
			"card_mode": "cover",
			"card_focus": Vector2(0.48, 0.5),
			"detail_image": "res://assets/art/player_mage_ultimate_cutin_candidate.png",
			"detail_mode": "contain",
		...
		},
		{
			...
			"card_image": "res://assets/art/hunter_select_reference.png",
			"card_mode": "cover",
			"card_focus": Vector2(0.24, 0.5),
			"detail_image": "res://assets/art/hunter_select_reference.png",
			"detail_mode": "contain",
			"detail_focus": Vector2(0.5, 0.5),
