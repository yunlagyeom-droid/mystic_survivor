...
static func get_characters() -> Array:
	return [
		...
		},
		{
			...
			"ultimate_prime_vfx_sheet": "res://assets/players/hunter/skills/ultimate/hunter_ultimate_prime_sheet.png",
			"ultimate_impact_vfx_sheet": "res://assets/players/hunter/skills/ultimate/hunter_ultimate_impact_sheet.png",
