...
func get_upgrade_pool() -> Array[Dictionary]:
	return [
		_make_upgrade("hunter_slash_growth", "에너지 슬래시", "피해 +6%, 베기 범위 +4%", "Rare", "slash", "res://assets/ui/hud/hunter_skill_sword_wave_casual_v2.png", "hunter_slash", slash_growth_level, 5),
		...
		_make_upgrade("hunter_dash_cooldown", "섀도우 스탭 쿨감", "재사용 대기시간 -7%. 3/5단계에서 스택 증가", "Rare", "dash", "res://assets/ui/hud/hunter_skill_dash_casual_v2.png", "hunter_dash_cooldown", dash_cooldown_level, 5),
		_make_upgrade("hunter_dash_distance", "섀도우 스탭 보폭", "이동거리 +35", "Rare", "dash", "res://assets/ui/hud/hunter_skill_dash_casual_v2.png", "hunter_dash_distance", dash_distance_level, 5),
		_make_upgrade("hunter_dash_path_damage", "섀도우 스탭: 레드 라인", "돌진 경로의 적에게 피해를 줍니다.", "Epic", "dash", "res://assets/ui/hud/hunter_skill_dash_casual_v2.png", "hunter_dash_path", 0, 1),
		_make_upgrade("hunter_dash_spinning_arrival", "섀도우 스탭: 블레이드 링", "도착 지점 주변을 회전 베기로 공격합니다.", "Epic", "dash", "res://assets/ui/hud/hunter_skill_dash_casual_v2.png", "hunter_dash_spin", 0, 1),
		_make_upgrade("hunter_parry_window", "카운터 엣지", "패링 판정시간 +0.04초", "Rare", "guard", "res://assets/ui/hud/hunter_skill_parry_casual_v2.png", "hunter_parry_window", guard_growth_level, 5),
		_make_upgrade("hunter_parry_counter", "카운터 엣지: 리포스트", "패링 성공 시 막은 방향으로 찌릅니다.", "Epic", "guard", "res://assets/ui/hud/hunter_skill_parry_casual_v2.png", "hunter_parry_counter", 0, 1),
		_make_upgrade("hunter_parry_counter_damage", "리포스트 강화", "반격 피해 +10%", "Rare", "guard", "res://assets/ui/hud/hunter_skill_parry_casual_v2.png", "hunter_parry_damage", parry_counter_level, 5),
		...
		_make_upgrade("hunter_sword_wave_growth", "레드 아크", "피해 +8%, 크기 +5%", "Rare", "sword_wave", "res://assets/ui/hud/hunter_skill_sword_wave_casual_v2.png", "hunter_red_arc", sword_wave_growth_level, 5),
		_make_upgrade("hunter_sword_wave_enhance", "레드 아크: 오버차지", "강화 검기 에셋으로 바뀌고 더 강해집니다.", "Epic", "sword_wave", "res://assets/ui/hud/hunter_skill_sword_wave_casual_v2.png", "hunter_red_arc_enhance", 0, 1),
		_make_upgrade("hunter_sword_wave_stack", "레드 아크: 더블 차지", "검기를 최대 2회 충전합니다.", "Epic", "sword_wave", "res://assets/ui/hud/hunter_skill_sword_wave_casual_v2.png", "hunter_red_arc_stack", 0, 1),
		_make_upgrade("hunter_ultimate_duration", "블레이드 오버로드 지속", "처형 모드 지속시간 +0.7초", "Rare", "ultimate", "res://assets/ui/hud/hunter_skill_ultimate_overload_casual_v1.png", "hunter_overload_duration", ultimate_duration_level, 5),
		_make_upgrade("hunter_ultimate_charge", "블레이드 오버로드 충전", "궁극기 게이지 획득량 +8%", "Rare", "ultimate", "res://assets/ui/hud/hunter_skill_ultimate_overload_casual_v1.png", "hunter_overload_charge", ultimate_charge_level, 5),
		_make_upgrade("hunter_ultimate_duration_epic", "오버로드: 레드 템포", "오버로드 중 기본공격 재사용 대기시간이 더 짧아집니다.", "Epic", "ultimate", "res://assets/ui/hud/hunter_skill_ultimate_overload_casual_v1.png", "hunter_overload_duration_epic", 0, 1),
		_make_upgrade("hunter_ultimate_charge_epic", "오버로드: 제로 스텝", "오버로드 중 섀도우 스탭 재사용 대기시간이 더 짧아집니다.", "Epic", "ultimate", "res://assets/ui/hud/hunter_skill_ultimate_overload_casual_v1.png", "hunter_overload_charge_epic", 0, 1),
		_make_upgrade("hunter_ultimate_finisher", "레전더리: 오버로드 브레이커", "오버로드 중 Q를 다시 눌러 필살 검기를 발사합니다.", "Legendary", "ultimate", "res://assets/ui/hud/hunter_skill_ultimate_overload_casual_v1.png", "hunter_overload_legendary", 0, 1),
		_make_upgrade("hunter_ultimate_blast", "레전더리: 크림슨 노바", "궁극기 발동 시 주변 적에게 폭발 피해를 줍니다.", "Legendary", "ultimate", "res://assets/ui/hud/hunter_skill_ultimate_overload_casual_v1.png", "hunter_overload_legendary", 0, 1),
	]
