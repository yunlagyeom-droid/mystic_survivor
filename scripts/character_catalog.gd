...
static func get_characters() -> Array:
	return [
		...
		},
		{
			...
			"concept_title": "캐릭터 정보",
			"concept": "헌터는 빠른 기동력과 짧은 사거리를 지닌 캐릭터입니다.\n패링과 돌진기를 활용해 스타일리시한 전투가 가능하며, 궁극기를 사용하면 처형모드에 돌입해 강력한 기술을 사용할 수 있습니다.",
			...
			"select_background_mode": "cover",
			"select_background_focus": Vector2(0.5, 0.5),
			"select_video": "res://assets/players/hunter/select/hunter_live_2d.mp4",
			"select_animation_sheet": "res://assets/players/hunter/select/hunter_live_2d_sheet_hq.png",
			"select_animation_columns": 8,
			"select_animation_rows": 12,
			"select_animation_fps": 24.0,
			"select_animation_mode": "cover",
			"select_animation_focus": Vector2(0.5, 0.5),
			"info_side": "left",
			"info_width": 470.0,
